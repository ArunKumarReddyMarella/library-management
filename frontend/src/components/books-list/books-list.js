    ...
    <>
      ...
      {books.length > 0 ? (
        <>
          <div>
          <Box sx={{ width: '100%' }}>
      <Grid container spacing={3} rowSpacing={3} columnSpacing={{ xs:4, sm:8, md:12 }}>
...
{/* <Item> */}
              <Card sx={{ maxWidth: 300 }} key={book.isbn} >
                <CardMedia
                  sx={{ height: 250 }}
                  image={book.image}
                  title={book.name}
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary" className={classes.extraText}>
                    {book.synopsis}
                  </Typography>
                </CardContent>
                <CardActions>
                  <Button variant="contained"
                            component={RouterLink}
                            size="small"
                            to={`/books/${book.isbn}`}>View</Button>
                  {isAdmin && (
                            <>
                              <Button
                                variant="contained"
                    ...
                    <TableBody>
                      {borrowedBook.map((book) => (
                        <TableRow key={book.isbn}>
                          ...
                          <TableCell align="right">{book.price === null ? '$0' : `$${book.price}`}</TableCell>
                          <TableCell>
